export const LOG_TEMPLATES = {
  ...
  BUG_MOVE: 'Bug[id={id}] move', BUG_ATTACK: 'Bug[type={type}] attack damage {value}', BUG_DEAD: 'Bug[type={type}] dead',
  ...
  SETTING_VOLUME: 'Settings volume {value}', SETTING_THEME: 'Settings theme {value}', SETTING_DIFFICULTY: 'Settings difficulty {value}', GAME_START: 'Game start {name}',
